...
# Loading the Realtime model                    
model = keras.models.load_model(r'C:\Users\91913\Desktop\final\Group_7_Realtime_sign_detection_e-DAI_May_2021\Realtime_Sign.h5')
model.load_weights(r'C:\Users\91913\Desktop\final\Group_7_Realtime_sign_detection_e-DAI_May_2021\Realtime_Sign.h5')


# Loading the CNN model    
cnn_model = keras.models.load_model(r'C:\Users\91913\Desktop\final\Group_7_Realtime_sign_detection_e-DAI_May_2021\CNN_Sign.h5')
cnn_model.load_weights(r'C:\Users\91913\Desktop\final\Group_7_Realtime_sign_detection_e-DAI_May_2021\CNN_Sign.h5')

# Labels for CNN model
labels = pd.read_csv("labels.csv").values

# REALTIME testing function
def frames():
    sequence = []
    sentence = []
    predictions = []
...
# Uploading face images to database
